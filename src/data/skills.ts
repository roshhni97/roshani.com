...
export const skills: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: 'Git', icon: SiGit, color: '#f05539' },
      { name: 'GraphQL', icon: SiGraphql, color: '#E10098' },
      { name: 'Figma', icon: SiFigma, color: '#f35424' },
      { name: 'AngularJS', icon: SiAngular, color: '#b63437' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'C', icon: SiC, color: '#084b87' },
      { name: 'C++', icon: SiCplusplus, color: '#084b87' },
      // { name: 'Java', icon: SiJava, color: '#F7DF1E' },
      { name: 'C#', icon: SiCsharp, color: '#3f0893' },
      { name: 'SQL', icon: SiSqlite, color: '#003c57' },
