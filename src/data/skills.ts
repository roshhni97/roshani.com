...
export const skills: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: 'Git', icon: SiGit, color: '#339933' },
      { name: 'GraphQL', icon: SiGraphql, color: '#E10098' },
      { name: 'Figma', icon: SiFigma, color: '#E10098' },
      { name: 'AngularJS', icon: SiAngular, color: '#E10098' },
  ...
  {
    id: '2',
    category: 'Languages Proficient',
    skills: [
      { name: 'Typescript', icon: SiTypescript, color: '#3178C6' },
      { name: 'Javascript', icon: Javascript, color: '#F7DF1E' },
      { name: 'C', icon: SiC, color: '#F7DF1E' },
      { name: 'C++', icon: SiCplusplus, color: '#F7DF1E' },
      // { name: 'Java', icon: SiJava, color: '#F7DF1E' },
      { name: 'C#', icon: SiCsharp, color: '#F7DF1E' },
      { name: 'SQL', icon: SiSqlite, color: '#F7DF1E' },
